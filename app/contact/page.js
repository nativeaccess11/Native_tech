    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!contactConfig.YOUR_SERVICE_ID || !contactConfig.YOUR_TEMPLATE_ID || !contactConfig.YOUR_USER_ID) {
                throw new Error('Email configuration is missing. Please check your EmailJS settings.');
            }
                                            ...
                                            <div className="contact-info-area-2">
                                                ...
                                                <div className="contact-info-items mb-4">
                                                    ...
                                                    <div className="content">
                                                        <p>Make a Quote</p>
                                                        <h3>
                                                            <Link href="/mailto:nativeaccess11@gmail.com">nativeaccess11@gmail.com</Link>
                                                        </h3>
                                                    </div>
                                                </div>
                    ...
                    <div className="map-section">
                        <div className="map-items">
                            <div className="googpemap">
                                <iframe 
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3890.1234567890123!2d130.8413!3d-12.4634!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2cc09a1392d0cfdf%3A0x400ef6143a2d200!2sDarwin%20NT%2C%20Australia!5e0!3m2!1sen!2sau!4v1641984054261!5m2!1sen!2sau" 
                                    style={{ border: 0 }} 
                                    allowFullScreen 
                                    loading="lazy" 
                                />
